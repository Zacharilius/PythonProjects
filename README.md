Marty2's Mega Project Ideas List

This list was posted to http://www.dreamincode.net/forums/topic/78802-martyr2s-mega-project-ideas-list/
in December 2008. It is over 100 projects that I am completing to get better with Python.
The projects are broken into 10 categories. The below descriptions are copied from the 
dreamincode.net post.
------------------------------------------------------------------------------------------

Numbers

Binary Decimal Converter - Converts from binary to decimal and from decimal to binary.

Calculator - A calculator that provides basic addition, subtraction, multiplication, and division of two numbers

Change - Calculates the amount of change in dollars and change to return to customers.

Fibonacci - Calculates the first 1000 numbers in the fibonacci sequence.

Next Prime - Given a number, this program calculates the next prime number that occurs after the user inputted number.

Pi - Calculates pi to the user specified digit.

Prime - Calculates if a user specified number is prime or not.
